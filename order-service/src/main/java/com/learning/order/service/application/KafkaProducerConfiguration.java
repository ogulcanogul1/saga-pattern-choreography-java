...
public class KafkaProducerConfiguration {
    ...
    public NewTopic orderCreatedTopic() {
        ...
        return TopicBuilder.name(KafkaTopics.ORDER_CREATED_EVENT)
                .partitions(3)
                .replicas(3)
    ...
    public NewTopic orderCompletedTopic() {
        ...
        return TopicBuilder.name(KafkaTopics.ORDER_COMPLETED_EVENT)
                .partitions(3)
                .replicas(3)
                .configs(Map.of("min.insync.replicas", "2"))
                .build();
    ...
    public NewTopic orderCancelledTopic() {
        ...
        return TopicBuilder.name(KafkaTopics.ORDER_CANCELLED_EVENT)
                .partitions(3)
                .replicas(3)
                .configs(Map.of("min.insync.replicas", "2"))
                .build();
