package com.learning.order.service.application;
...
////        config.put(JsonDeserializer.VALUE_DEFAULT_TYPE, defaultValueType);
//
//        return new DefaultKafkaConsumerFactory<>(config);
//    }
//
//    // KafkaTemplate: DeadLetterPublishingRecoverer için gerekli
//    @Bean
//    public KafkaTemplate<String, Object> kafkaTemplate(ProducerFactory<String, Object> producerFactory) {
//        return new KafkaTemplate<>(producerFactory);
//    }
//
//    // ProducerFactory: KafkaTemplate için gerekli
//    @Bean
...
//        DefaultErrorHandler errorHandler = new DefaultErrorHandler(
//                new DeadLetterPublishingRecoverer(kafkaTemplate),
//                new FixedBackOff(5000L, 3L) // 5s bekle, 3 kez dene
//        );
//
