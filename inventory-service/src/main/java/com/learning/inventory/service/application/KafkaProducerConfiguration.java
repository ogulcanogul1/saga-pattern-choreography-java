...
public class KafkaProducerConfiguration {
    ...
    public NewTopic orderCreatedTopic() {
        ...
        return TopicBuilder.name(KafkaTopics.INVENTORY_RESERVED_EVENT)
                .partitions(3)
                .replicas(3)
    ...
    public NewTopic orderCompletedTopic() {
        ...
        return TopicBuilder.name(KafkaTopics.INVENTORY_RESTORED_EVENT)
                .partitions(3)
                .replicas(3)
                .configs(Map.of("min.insync.replicas", "2"))
                .build();
    ...
    public NewTopic orderCancelledTopic() {
        ...
        return TopicBuilder.name(KafkaTopics.INVENTORY_DECLINED_EVENT)
                .partitions(3)
                .replicas(3)
                .configs(Map.of("min.insync.replicas", "2"))
                .build();
